...
public class App {
    public static void main(String[] args) {
        ...
        {
            weathers.add(new Weather(50, "Московская область", 23.1, LocalDateTime.parse("2023-09-24T12:10:00")));
            weathers.add(new Weather(69, "Тверская область", 19.2, LocalDateTime.parse("2023-09-21T13:00:00")));
            ...
            weathers.add(new Weather(69, "Московская область", 24.2, LocalDateTime.parse("2023-09-01T15:00:00")));
        }
        ...
        Map<Long,List<Weather>> mapWeathersByTemp=weathers.stream()
                 .collect(Collectors.groupingBy(w->Math.round(w.getValueTemp())));
    }
}
